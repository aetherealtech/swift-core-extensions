...
final class AsyncCollectionTests: XCTestCase {
    ...
    func testAwaitAll() async throws {
        ...
        let jobs = SyncDestructiveSequence((0..<50)
            .map { index in
    ...
    @MainActor
    func testAwaitAllCollection() async throws {
        var concurrency = 0
        var maxConcurrency = 0
    ...
    @MainActor
    func testAwaitAllThrowingNoThrowsCollection() async throws {
        var concurrency = 0
        var maxConcurrency = 0
    ...
    @MainActor
    func testAwaitAllThrowingThrowsCollection() async throws {
        var concurrency = 0
        var maxConcurrency = 0
